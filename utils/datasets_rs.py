...
class LoadRealSense:  # Stream from Intel RealSense D435
    ...
    # def __init__(self, sources='streams.txt', img_size=418, width='640', height='480', fps='30', stride=32, auto=True):
    def __init__(self, sources='streams.txt', img_size=640, width='640', height='480', fps='30', stride=32, auto=True):
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
        ...
        n = len(sources)
        self.imgs, self.fps, self.frames, self.threads, self.aligned_frames = [None] * n, [0] * n, [0] * n, [None] * n, [None] * n
